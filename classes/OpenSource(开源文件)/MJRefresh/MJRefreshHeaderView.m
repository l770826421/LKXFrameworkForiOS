...
- (void)updateTimeLabel
{
    ...
    if ([cmp1 day] == [cmp2 day]) { // 今天
        formatter.dateFormat = @"Today HH:mm"; //@"今天 HH:mm";
    ...
    // 3.显示日期
    self.lastUpdateTimeLabel.text = [NSString stringWithFormat:@"最后更新：%@", time]; // [NSString stringWithFormat:@"Last updated：%@", time];// [NSString stringWithFormat:@"最后更新：%@", time];
}
