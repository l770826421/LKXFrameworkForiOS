...
- (void)showActivityIndicator
{
    [self implementMBHUD];
    mbHud.mode = MBProgressHUDModeIndeterminate;
    mbHud.detailsLabelText = kLocalizedString(@"Uploading");
    mbHud.dimBackground = NO;
    [[kAppDelegate window] addSubview:mbHud];
    [mbHud show:YES];
    
    [mbHud hide:YES afterDelay:30.0f];
}
...
- (void)showCustomView
{
    ...
    mbHud.dimBackground = NO;
    [[kAppDelegate window] addSubview:mbHud];
    mbHud.customView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"photo_down"]];
    [mbHud show:YES];
}
